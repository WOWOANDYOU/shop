	...
	<div class="add_good_in">
		...
		<div class="add_good_in_down">
			<c:choose>
				...
				<form
					action="${pageContext.request.contextPath }/servlet/ModifyGoodServlet?uuid=${formuuidnum}&good_type=${good_type }"
					method="post" onsubmit="return checkoutfilename()"
					enctype="multipart/form-data">
					<input type="hidden" value="${modify_book.store_id }" name="store_id">
