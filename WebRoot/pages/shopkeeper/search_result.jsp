	...
	-->
		<div id="show_goods_div_big">
			<div id="show_goods_div">
				...
				<c:if test="${not empty listcloth_search}">
				...
				<c:if test="${not empty listbook_search}">
					<div id="show_goods_div_in_up">
				...
				<c:if test="${not empty listfood_search}">
					<div id="show_goods_div_in_up">
						<div class="title_up"></div>
				...
				<c:if test="${empty listbook_search && empty listfood_search && empty listcloth_search }">
					<div id="none_good"><font style="color:red;font-size:16px">对不起啦，没找到你要找到商品啊</font></div>
				</c:if>
			</div>
